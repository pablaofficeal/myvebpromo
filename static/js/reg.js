...
function checkIfUserLoggedIn() {
    if (checkLocalStorage() || checkCookies()) {
        ...
        window.location.href = "log.html"; // Перенаправление на страницу логина, если данные не найдены
    }
}
...
function logoutUser() {
    ...
    window.location.href = "log.html"; // Перенаправление на страницу логина
}
